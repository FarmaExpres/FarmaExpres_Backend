...
GRANT SELECT, INSERT, UPDATE, DELETE ON TABLE refresh_token TO farmaexpres_auth_app;
...
GRANT USAGE, SELECT ON SEQUENCE refresh_token_id_seq TO farmaexpres_auth_app;
...
GRANT SELECT ON TABLE refresh_token TO farmaexpres_auth_readonly;
...
GRANT SELECT ON SEQUENCE refresh_token_id_seq TO farmaexpres_auth_readonly;
