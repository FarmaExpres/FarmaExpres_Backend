...
REVOKE SELECT ON SEQUENCE refresh_token_id_seq FROM farmaexpres_auth_readonly;
...
REVOKE SELECT ON TABLE refresh_token FROM farmaexpres_auth_readonly;
...
REVOKE USAGE, SELECT ON SEQUENCE refresh_token_id_seq FROM farmaexpres_auth_app;
...
REVOKE SELECT, INSERT, UPDATE, DELETE ON TABLE refresh_token FROM farmaexpres_auth_app;
